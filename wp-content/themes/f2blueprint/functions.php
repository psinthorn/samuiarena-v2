...
<?php
    ...
    wp_enqueue_script('main-university-js', get_theme_file_uri('/bundled-assets/scripts.53b6221c9f11faf5d74f.js'), NULL, '1.0', true);
    wp_enqueue_style('our-main-styles', get_theme_file_uri('/bundled-assets/styles.53b6221c9f11faf5d74f.css'));
        }

            // wp_enqueue_script('vendors-js', get_theme_file_uri('/bundled-assets/vendors~scripts.8c97d901916ad616a264.js'), NULL,'1.0', true );
            // wp_enqueue_script('primary-main-js', get_theme_file_uri('/bundled-assets/scripts.53b6221c9f11faf5d74f.js'), NULL,'1.0', true );
            // wp_enqueue_style('main_styles', get_stylesheet_uri('/bundled-assets/styles.53b6221c9f11faf5d74f.css'));

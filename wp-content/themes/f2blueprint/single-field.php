...
?>
  <div class="container container--narrow page-section">
    <div class="metabox metabox--position-up metabox--with-home-link">
      <p><a class="metabox__blog-home-link" href="<?php echo get_post_type_archive_link('field'); ?>"><i class="fa fa-home" aria-hidden="true"></i> Fields Home</a> <span class="metabox__main"><?php the_title(); ?></span></p>
    </div>
